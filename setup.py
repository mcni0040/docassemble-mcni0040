...
setup(name='docassemble.mcni0040',
      ...
      url='https://github.com/LLAW3301/docassemble-LLAW33012020S1P18/tree/mcni0040',
      packages=find_packages(),
      namespace_packages=['docassemble'],
      install_requires=[],
      zip_safe=False,
      package_data=find_package_data(where='docassemble/mcni0040/', package='docassemble.mcni0040'),
     )
